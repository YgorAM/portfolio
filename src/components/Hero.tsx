...
const Hero = () => {
  return (
    <section id="inicio" className="min-h-screen flex items-center justify-center section-padding pt-20 md:pt-16 pb-16 md:pb-4 bg-gradient-to-br from-background to-muted">
